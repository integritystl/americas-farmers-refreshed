                                        ...
                                        <table class="hero-content" align="left"
                                            ...
                                            <tr style="padding: 0; text-align: left; vertical-align: top;">
                                                <td class="hero-title"
                                                    ...
                                                    <h2 style="Margin: 0; Margin-bottom: 0; color: #555555; font-family: Helvetica, Arial, sans-serif; font-size: 30px; font-weight: 700; line-height: 1em; margin: 0; margin-bottom: 0; padding: 0; padding-left: 9px; text-align: left; text-transform: uppercase; word-wrap: normal;"><?php _e( "Audit Update From",
															'wpdef' ) ?></h2>
                                        ...
                                        <table
                                            ...
                                            <tr style="padding: 0; text-align: left; vertical-align: top;">
                                              ...
                                              <span class="plugin-title hummingbird"
                                                    style="color: #febd30; display: block;"><strong><?php esc_html_e( "Hummingbird",
			                                              'wpdef' ) ?></strong></span>
                                              </span>
                                                                </a>
                                                            </th>
                                              ...
                                              <span class="plugin-title snapshot"
                                                    style="color: #642486; display: block;"><strong><?php _e( "Snapshot",
			                                              'wpdef' ) ?></strong></span>
                                              </span>
                                                                </a>
                                                            </th>
